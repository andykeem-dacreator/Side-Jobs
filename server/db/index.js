...
const syncAndSeed = async () => {
  ...
  const [
    ...
    Task.create({
      ...
      userId: larry.id,
      taskDoerId: ethyl.id,
      lat: faker.location.latitude({ max: 39.9143, min: 39.7392, precision: 5 }),
      lng: faker.location.longitude({ max: -104.6785, min: -105.1099, precision: 5 }),
    }),
    Task.create({
    ...
    Task.create({
      ...
      userId: larry.id,
      taskDoerId: ethyl.id,
      lat: faker.location.latitude({ max: 39.3539, min: 39.0997, precision: 5 }),
      lng: faker.location.longitude({ max: -94.5786, min: -94.9416, precision: 5 }),
    }),
    Task.create({
      ...
      userId: larry.id,
      taskDoerId: ethyl.id,
      lat: faker.location.latitude({ max: 40.8428, min: 40.6441, precision: 5 }),
      lng: faker.location.longitude({ max: -111.8818, min: -112.0419, precision: 5 }),
    }),
    Task.create({
    ...
    Task.create({
      ...
      userId: moe.id,
      taskDoerId: lucy.id,
      lat: faker.location.latitude({ max: 36.4079, min: 36.1024, precision: 5 }),
      lng: faker.location.longitude({ max: -86.6782, min: -87.0245, precision: 5 }),
    }),
    Task.create({
    ...
    Task.create({
      ...
      userId: andy.id,
      taskDoerId: lucy.id,
      lat: faker.location.latitude({ max: 41.3182, min: 41.2079, precision: 5 }),
      lng: faker.location.longitude({ max: -95.9614, min: -96.1260, precision: 5 }),
    }),
    Task.create({
